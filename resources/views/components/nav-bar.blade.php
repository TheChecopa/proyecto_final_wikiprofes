<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <a class="navbar-brand" href="#">
            <img src="{{asset('')}}" class="d-inline-block align-top" alt="" style="max-width:3rem;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarMobileToggle">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{route('mainIndex')}}">WIKIPROFES</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('calificacionIndex')}}">Comentarios</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('PuntuacionIndex')}}">Materias</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('profesorIndex')}}">Profesores</a>
                </li>
            </ul>
